...
fail=0
for t in test/wp1.test.ts test/setup.test.ts test/ledger.test.ts test/roles.test.ts test/wp5-fixes.test.ts test/e2e-fake.ts test/wp6.test.ts test/wp7.test.ts test/runner-direct-offline.test.ts; do
  printf '%-42s ' "$t"
